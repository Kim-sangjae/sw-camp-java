...
class AssertJTests {
    ...
    void testLocalDateTime(){
        ...
        Assertions.assertThat(localDateTime)
                ...
                .hasMonthValue(9)
                .hasDayOfMonth(18)
                .isBetween("2014-09-18T16:42:00.000","2014-12-31T16:42:00.000")
    ...
    void testFilteringAssertions(){
        ...
        Member member2 = new Member(2,"user02","이순신", 24);
        Member member3 = new Member(3,"user03","선덕여왕",140);
